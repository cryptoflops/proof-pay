(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,869609,e=>{"use strict";e.i(864380),e.s([])},538822,e=>{"use strict";e.i(812207);var t=e.i(108285),i=e.i(654479);e.i(374576);var n=e.i(120119);e.i(684326);var o=e.i(765090),r=e.i(162611),a=e.i(459088),s=e.i(112699),l=e.i(645975);let c=r.css`
  :host {
    position: relative;
...
`;var D=function(e,t,i,n){var o,r=arguments.length,a=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(r<3?o(a):r>3?o(t,i,a):o(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};let z=class extends P.LitElement{constructor(){super(),this.unsubscribe=[],this.assets=l.ExchangeController.state.assets,this.search="",this.onDebouncedSearch=S.CoreHelperUtil.debounce(e=>{this.search=e}),this.unsubscribe.push(l.ExchangeController.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return i.html`
    ...
    `}onBuyClick(){c.RouterController.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){l.ExchangeController.setPaymentAsset(e),c.RouterController.goBack()}};z.styles=A,D([(0,n.state)()],z.prototype,"assets",void 0),D([(0,n.state)()],z.prototype,"search",void 0),z=D([(0,h.customElement)("w3m-deposit-from-exchange-select-asset-view")],z),e.s(["W3mDepositFromExchangeSelectAssetView",0,z],517240),e.s([],649059),e.i(649059),e.i(807189),e.i(517240),e.s(["W3mDepositFromExchangeSelectAssetView",0,z,"W3mDepositFromExchangeView",0,E],837116)}]);